...
lemma parallel_symm (l₁ l₂ : line) : parallel l₁ l₂ → parallel l₂ l₁ := by
  intro h; obtain ⟨z, hz⟩ := h; use -z; simp[hz]

lemma parallel_basis(l₁ l₂ : line) : l₁.z₁ - l₂.z₁ = l₁.z₂ - l₂.z₂ → parallel l₁ l₂  := by
  intro h; unfold parallel; use l₁.z₁ - l₂.z₁; unfold line.points; ext x; simp; constructor
  intro hx; obtain ⟨t, ht⟩ := hx; have hr: ∃ r:ℝ,r = t*(l₁.z₁ - l₁.z₂) / (l₂.z₁ - l₂.z₂):= by {have h: (t*(l₁.z₁ - l₁.z₂) / (l₂.z₁ - l₂.z₂)).im = 0 := by {sorry}; sorry}; obtain ⟨r, hr⟩ := hr; use r; rw [←ht, sub_mul, ←@add_sub_assoc, ←@add_sub_assoc]; sorry --TODO: Umformung
  sorry
...
lemma l_in_L_M_imp (M:Set ℂ)(l: line) (hl: l ∈ L M ): l.z₁ ∈ M ∧ l.z₂ ∈ M := by
  obtain ⟨z₁, z₂, hl, hz₁, hz₂, _⟩ := hl; constructor; rw [hl]; exact hz₁; rw [hl]; exact hz₂

lemma l_in_L_M_imp' (M:Set ℂ)(l: line) (hl: l ∈ L M ): l.z₁ ≠ l.z₂ := by
  obtain ⟨z₁, z₂, hl, _, _, Noteq⟩ := hl; rw[hl]; exact Noteq
