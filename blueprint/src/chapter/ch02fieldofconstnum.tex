...
\begin{proof}
    ...
    "$\Leftarrow$": For $ x_1 \ne x_2$ and $y_1 \ne y_2$ chose 
        \begin{align*}
            z_1 &:= (\frac{r_1^2 - r_2^2 + x_2^2 - x_1^2 + (\imath y_2)^2 - (\imath y_1)^2-2(y_2-y_1)y_1}{2(x_2-x_1)}) + \imath y_1\\ % x_1 + \imath (\frac{r_1^2 - r_2^2 + x_2^2 - x_1^2 + (\imath y_2)^2 - (\imath y_1)^2-2(x_2-x_1)x_1}{2(y_2-y_1)})\\
