...
\begin{lemma}
    ...
    \lean{Construction.circel_not_eq_iff, Construction.circle_not_eq_iff_radius}
    \leanok
    \uses{def:circel}
...
\begin{lemma} 
    ...
    \lean{Construction.line_points_iff}
    \leanok
    \uses{def:line}
...
\begin{proof}
    ...
    If we have $z_1 = z_2$ we get define $c_1 = \{z_1,\dist (0\ z_1)\}$ and $l = \{0,z_1\}$ and get that $z_1 + z_2 \in c_1 \cap l$.
\end{proof}
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
